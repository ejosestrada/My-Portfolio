...
apiKey <- register_google("AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
...
Jamba <- google_places(search_string = "Jamba Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
Cinnabon <- google_places(search_string = "cinnabon Raleigh, North Carolina",radius=50000, key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
Auntie <- google_places(search_string = "Auntie Anne's Raleigh, North Carolina",radius=50000, key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
Carvel <-google_places(search_string = "CarvelRaleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
...
BaskinRobbins <- google_places(search_string = "Baskin Robbins Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
DairyQueen <- google_places(search_string = "Dairy Queen Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
ColdStone <- google_places(search_string = "Cold Stone Creamery Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
MarbleSlab <-google_places(search_string = "Marble Slab Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
HaagenDaz <- google_places(search_string = "Haagen Daz Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
...
Cinnaholic <- google_places(search_string = "Cinnaholic Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
GreatAmericanCookies <-google_places(search_string = "Great American Cookies Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
CrumblCookies <- google_places(search_string = "Crumbl Cookies Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
Wetzels <- google_places(search_string = "Wetzel's Pretzels Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
PretzelTime <- google_places(search_string = "Pretzel Time Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
Bakeries <- google_places(search_string = "Bakeries Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
KrispyKreme <- google_places(search_string = "Krispy Kreme Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
...
TropicalSmoothie <- google_places(search_string = "Tropical Smoothie Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
PlanetSmoothie <- google_places(search_string = "Planet Smoothie Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
SmoothieKing <- google_places(search_string = "Smoothie King Raleigh, North Carolina",radius=50000,  key = "AIzaSyCckgfbJAkXe-q1MPYzG8g75uce9_7y0Co")
